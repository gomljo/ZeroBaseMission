...
public final class PublicWifiQuery {
    ...
    public static final String FROM = String.format("%s%s ", "from ", TABLE_NAME);
    public static final String JOIN_ADDRESS = "pw left outer join address addr on pw.address_Id = addr.address_Id";
    public static final String JOIN_INSTALLATION = "left outer join installation install on pw.installation_Id = install.installation_Id left";
    public static final String JOIN_WIFI = "outer join wifi on pw.wifi_Id = wifi.wifi_Id limit(100)";
