...
public class WifiDeserializer implements JsonDeserializer<JsonRequestWifiDto> {
    @Override
    public JsonRequestWifiDto deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        JsonObject openApiData = (JsonObject) json.getAsJsonObject();
        return JsonRequestWifiDto.builder()
