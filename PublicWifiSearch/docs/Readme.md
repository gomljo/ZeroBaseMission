...
- [X] 필수 준수 사항 (1): 과제를 분석하여 ERD를 통한 데이터 설계를 작성하여 제출해 주세요.  
...
- [X] 필수 준수 사항 (3): JAVA 기반의 다이나믹 웹서비스를 이용해서 구현해 주세요.(JSP)  
...
- [X] 기능 사항 (2): 내 위치 정보를 입력하면 가까운 위치에 있는 와이파이 정보 20개 보여주는 기능 구현  
...
- [X] 기능 사항 (3): 내가 입력한 위치정보에 대해서 조회하는 시점에 DB에 히스토리를 저장 및 보여주는 기능 구현  
...
- [X] 기능 사항 (7): 와이파이 북마크에 추가 및 삭제 기능 구현  
...
### 2️⃣ 테이블 생성 및 저장
  ...
  - [X] 공공 와이파이 테이블 생성
  - [X] 공공 와이파이 테이블에 해당하는 데이터 저장  


  - [X] 히스토리 테이블 생성
  - [X] 히스토리 테이블에 해당하는 데이터 저장  

    
  - [X] 북마크 테이블 생성
  - [X] 북마크 테이블에 해당하는 데이터 저장  
...
- [X] 내 위치와 가까운 20개의 공공 와이파이 정보 구하기
- [X] 가까운 20개의 공공 와이파이 상세 정보 보여주기
