package com.publicwifisearch.domain.publicWifi.openAPI;

import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.publicwifisearch.domain.publicWifi.PublicWifiData;
...
public class OpenAPI {
    ...
    public PublicWifiData convertToJson(){
        Gson gson = new Gson();
        ...
        return gson.fromJson(publicWifiJson, PublicWifiData.class);
    }

    public PublicWifiData request(URLMaker urlMaker){
